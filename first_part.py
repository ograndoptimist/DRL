...
class AdmiravelMundoNovo(object):
    ...
    def estado_inicial(self):
        ...
        return self.reforco, self.estado_texto, self.estado_acao, self.valor_estado, self.finalizado
    ...
    def estado_1(self):
        ...
        self.estado_acao = "\t[0] Abra a porta.\n\t[1] Vá para o leste.\n\t[2] Vá para o oeste."
        return self.reforco, self.estado_texto, self.estado_acao, self.valor_estado, self.finalizado
    ...
    def estado_final(self):
        ...
        return self.reforco, self.estado_texto, self.finalizado
